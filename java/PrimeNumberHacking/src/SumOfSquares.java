//desc: Sum of Squares method
//      Please note the run() function has to be terminated manually
...
public class SumOfSquares implements Runnable {
    ...
    //make use of biginteger functions
    //if square, there is no remainder for sqrt, so second value should be 0
